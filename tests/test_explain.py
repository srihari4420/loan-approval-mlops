...
def test_shap_values_have_consistent_sign(trained_xgb: tuple) -> None:
    """A positive SHAP value should mean 'pushes prediction toward class 1'."""
    pipeline, X, _ = trained_xgb
    ...
    # SHAP sum + base should approximate the logit of predicted probability.
    # We don't test exact equality (link functions differ); just that sign correlates.
